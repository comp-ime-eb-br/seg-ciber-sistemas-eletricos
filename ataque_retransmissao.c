...
main(int argc, char** argv)
{
    ...
    //Condicao presente no código exemplo Goose publicador da biblioteca libiec61850 para verificacao do uso da interface de rede
    if (argc > 1) {
    ...
    if (GooseReceiver_isRunning(monitoramento)) {
        ...
        while (running) {
            ...
            if (cont == intervalo_set) {
                ...
                // DEFINIR DATASET do pacote de ataque - pelo atacante
                ...
                //ATAQUE DE RETRANSMISSAO - ao contrario do ataque de mascaramento, os parametros sqnum e stnum sao mantidos o mesmo da mensagem original
